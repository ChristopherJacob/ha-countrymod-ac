...
- Wind speed, light, screen-display, swing, and timer entries are additional app-visible controls recorded for static completeness only; this document makes no claim that any is a supported version-1 integration control.
